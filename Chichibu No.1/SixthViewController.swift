...
class SixthViewController: UIViewController {
    ...
    let al_culture_image = [#imageLiteral(resourceName: "秩父事件😭"), #imageLiteral(resourceName: "秩父銘仙　完成"), #imageLiteral(resourceName: "秩父夜祭"), #imageLiteral(resourceName: "秩父のお金？？？？？？？？？？？？？"), #imageLiteral(resourceName: "巡礼in the 秩父神社"), #imageLiteral(resourceName: "橋立鍾乳洞")]
