...
class tenViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if f_index == 0 {
            food_name.textColor = .systemGreen
            food_explanation.textColor = .systemGreen
        } else if f_index == 1 {
            food_name.textColor = .systemGreen
            food_explanation.textColor = .systemGreen
        } else if f_index == 2 {
